...
#End If
		...
		Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
			WebApplication.SetInstance(Session, New NavBarExampleAspNetApplication())
			WebWindowTemplateHttpHandler.PreferredApplicationWindowTemplateType = TemplateType.Horizontal
#If EASYTEST Then
